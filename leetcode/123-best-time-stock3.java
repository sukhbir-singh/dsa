...
// In this problem, there are three changing states and so three dimensional dp array will be used - Nx2x3
// Another approach is to use 2D DP using - Nx4 size array (by considering transaction numbers instead)
class Solution {
